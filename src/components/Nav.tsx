...
export default function Nav({ locale }: { locale: "ko" | "en" }) {
  ...
  const t = locale === "ko"
    ? { features: "원칙", architecture: "아키텍처", industries: "분야", roadmap: "로드맵", evidence: "KPI", contact: "상담" }
    : { features: "Principles", architecture: "Architecture", industries: "Industries", roadmap: "Roadmap", evidence: "KPI", contact: "Contact" };
  return (
    <nav className="sticky top-0 z-30 bg-white/90 backdrop-blur border-b border-maru-100">
      <div className="container-narrow flex items-center justify-between py-4">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm text-maru-900/80">
          ...
          <a href="#roadmap" className="hover:text-maru-900">{t.roadmap}</a>
